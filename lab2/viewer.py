...
class Triangle(Mesh):
    """ Class for drawing a triangle object """
    def __init__(self, shader, position, color):
        self.color = (.5, .5, .5)
...
def main():
    ...
    # color = np.array(((1, 1, 0), (0, 1, 1), (1, 0, 1)), 'f')
    # new_mesh = Triangle(color_shader, position, color)
    # viewer.add(new_mesh)
